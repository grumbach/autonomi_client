...
1. Go to the [Releases](https://github.com/maidsafe/autonomi_client/releases) page on GitHub.
...
For issues specific to the CLI, please use the [autonomi_client repository](https://github.com/maidsafe/autonomi_client/issues).
